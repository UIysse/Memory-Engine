...
public:
    ...
    void setupUi(QMainWindow *QtProClass)
    {
		...
		QtProClass->setWindowIcon(QIcon("QtPro.ico"));
        ...
        progressBar->setGeometry(QRect(110, 20, 891, 16));
        progressBar->setValue(0);
        checkBox = new QCheckBox(centralWidget);
        checkBox->setObjectName(QStringLiteral("checkBox"));
        checkBox->setGeometry(QRect(710, 110, 51, 20));
    ...
    void retranslateUi(QMainWindow *QtProClass)
    {
        ...
        checkBox->setText(QApplication::translate("QtProClass", "Hex", 0));
