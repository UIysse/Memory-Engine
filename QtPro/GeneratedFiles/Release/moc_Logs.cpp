...
struct qt_meta_stringdata_Logs_t {
    QByteArrayData data[1];
    char stringdata0[5];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Logs_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Logs_t qt_meta_stringdata_Logs = {
    {
QT_MOC_LITERAL(0, 0, 4) // "Logs"
...
const QMetaObject Logs::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Logs.data,
      qt_meta_data_Logs,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Logs::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Logs.stringdata0))
